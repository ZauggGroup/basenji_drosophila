...
/g/scb/zaugg/stojanov/development/miniconda3/envs/basenji/bin/python basenji_sad.py -f /g/scb/zaugg/stojanov/basenji/experiments/data/dm6.UCSC.noMask.fa -o /g/scb/zaugg/stojanov/basenji/experiments/variants_predictions/sad_scores/ --rc --shifts "1,0,-1" -t /g/scb/zaugg/stojanov/basenji/experiments/data/drosophila.txt /g/scb/zaugg/stojanov/basenji/experiments/models/drosophila_l131k_augmented/params.json /g/scb/zaugg/stojanov/basenji/experiments/models/drosophila_l131k_augmented/model_best.h5 /g/scb/zaugg/stojanov/basenji/experiments/data/Haplotype_joint_call_F1_stringent_filtering.vcf
conda deactivate
echo '...done.'
