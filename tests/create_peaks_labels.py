...
def create_peaks_labels(data_dir, split_label, peaks_file):
    ...
    for l in labels:
        ...
        np.savez_compressed(os.path.join(data_dir, 'labels', f'{l}_peaks.npz'), data=array)


if __name__ == '__main__':
    # data_dir = '/g/scb/zaugg/stojanov/basenji/experiments/data/new_data/drosophila_l131k'
    # data_dir = '/g/scb/zaugg/stojanov/basenji/experiments/data/new_data/drosophila_l65k'
    data_dir = '/g/scb/zaugg/stojanov/basenji/experiments/data/new_data/drosophila_l32k'
    peaks_file = '/g/scb/zaugg/stojanov/basenji/experiments/data/new_data/peaks_all_conditions.txt'
    split_label = 'test'
    create_peaks_labels(data_dir, split_label, peaks_file)
